...
const clientNavItems: NavItem[] = [
  ...
  { name: 'Mes réservations', href: '/dashboard/client/bookings', icon: Calendar },
...
const providerNavItems: NavItem[] = [
  ...
  { name: 'Mes réservations', href: '/dashboard/provider/bookings', icon: Calendar },
...
const adminNavItems: NavItem[] = [
  ...
  { name: 'Réservations', href: '/dashboard/admin/bookings', icon: Calendar },
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="border-t p-3">
        {/* /help not yet implemented — links to homepage */}
        <Link
          href="/"
      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="flex items-center justify-between h-16 px-4 sm:px-6">
            ...
            <h1 className="lg:hidden text-lg font-semibold">Tableau de bord</h1>
