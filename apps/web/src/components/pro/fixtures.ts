import type { ActiveJob, InboundRequest, LineItemPreset } from "./types";

// DS07 — mock data for JobRequests + QuoteCompose. Shape mirrors the v2
// prototype (prototype/components/JobRequests.jsx + QuoteCompose.jsx).
// Backend wiring lands in a later chunk — see PROGRESS.md blockers.
