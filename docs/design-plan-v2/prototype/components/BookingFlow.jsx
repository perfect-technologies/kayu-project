...
function KayouMoment({ client, provider, mobile, onDone }) {
  ...
  return (
    <div style={{ background: "var(--k-bg)", minHeight: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 20px", textAlign: "center" }}>
      ...
      <h1 className="k-display-l" style={{ margin: "0 0 10px", fontSize: mobile ? 28 : 36, animation: "kmRise 500ms 200ms both", letterSpacing: "-0.02em" }}>
        C'est noté !
      </h1>
      ...
      {/* Booking summary card — Airbnb-style soft card, no border */}
      <div style={{
        marginTop: 36, background: "white",
        borderRadius: 18, padding: "16px 18px",
        width: "min(420px, 100%)",
        boxShadow: "0 10px 28px -12px rgba(15,23,42,0.14), 0 2px 6px -2px rgba(15,23,42,0.05)",
        animation: "kmRise 600ms 600ms both",
      }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, textAlign: "left" }}>
          <div>
            <div className="k-caption">Référence</div>
            <div className="k-price" style={{ fontSize: 14, marginTop: 2 }}>#KY-4829-AM</div>
          </div>
          <div>
            <div className="k-caption">Date</div>
            <div className="k-body-m" style={{ fontWeight: 600, marginTop: 2 }}>Mer. 18 avril · 10:00</div>
          </div>
        </div>
      </div>

      <div style={{ display: "flex", gap: 10, marginTop: 20, width: "min(420px, 100%)", animation: "kmRise 600ms 720ms both" }}>
        <button
          onClick={onDone}
          style={{
        ...
        <button className="k-btn k-btn-primary" style={{ flex: 1.2, height: 48, borderRadius: 14, fontSize: 14 }} onClick={onDone}>
          Voir ma réservation
        </button>
      </div>
    </div>
