...
export const BookingClientReviewSummarySchema = z.object({
  id: IdSchema,
  bookingId: IdSchema,
  clientId: IdSchema,
  providerId: IdSchema,
...
export const BookingSchema = z.object({
  ...
  duration: z.number().int().nullable().optional(),
  price: z.number().nullable().optional(),
  commissionPct: z.number().int().optional(),
  commissionAmt: z.number().int().optional(),
  providerNetAmt: z.number().int().optional(),
